...
public class TileEntityDecompressor extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public String getName() {
		return this.hasCustomName() ? this.furnaceCustomName : "container.jac.decompressor";
	}
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockDecompressor.setState(this.isBurning(), this.world, this.pos);
			}
		}
			...
			if (itemstack.isEmpty()) {
				...
				if (itemstack1.isEmpty()) {
					...
					return false;
						...
						&& itemstack1.getCount() + itemstack.getCount() <= itemstack1.getMaxStackSize()) // Forge
																											// fix:
																											// make
																											// furnace
																											// respect
																											...
																											// recipes
				{
					...
					return itemstack1.getCount() + itemstack.getCount() <= itemstack.getMaxStackSize(); // Forge
																										// fix:
																										// make
																										// furnace
																										// respect
